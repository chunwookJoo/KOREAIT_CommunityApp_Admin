...
!(function (h) {
    ...
    tablesorter: new (function () {
      function d() {
        ...
        if (
          ...
          console[
            /error/i.test(b) ? "error" : /warn/i.test(b) ? "warn" : "log"
          ](a);
        else alert(a);
      }
      function q(b, a) {
        ...
        var f,
          ...
          d =
            "basic" === l
              ...
              : "function" === typeof l
              ? l(a, b, c)
              : "function" === typeof (f = g.getColumnData(b, l, c))
              ? f(a, b, c)
              : a.textContent || a.innerText || h(a).text() || "";
        return h.trim(d);
      }
      function v(b) {
        var a,
          c,
          f = b.config,
          e = (f.$tbodies = f.$table.children(
            "tbody:not(." + f.cssInfoBlock + ")"
          )),
          l,
          x,
          k,
        ...
        if (0 === w)
          return f.debug
            ? d("Warning: *Empty table!* Not building a parser cache")
            : "";
          ...
          if (l[p])
            for (x = f.columns, k = 0; k < x; k++) {
              ...
              f.empties[k] = (
                g.getData(h, m, "empty") ||
                f.emptyTo ||
                (f.emptyToBottom ? "bottom" : "top")
              ).toLowerCase();
              f.strings[k] = (
                g.getData(h, m, "string") ||
                f.stringTo ||
                "max"
              ).toLowerCase();
        ...
        f.debug &&
          (d(v ? v : "No parsers detected"),
          q("Completed detecting parsers", t));
        f.parsers = c;
        f.extractors = a;
      }
      function w(b) {
        ...
        if (!w)
          return s.debug
            ? d("Warning: *Empty table!* Not building a cache")
            : "";
        s.debug && (n = new Date());
          ...
          if (
            ...
            for (f = 0; f < m; ++f)
              if (
                ...
                (x = h(t[l].rows[f])),
                (k = []),
                x.hasClass(s.cssChildRow) && 0 !== f)
              )
                (c = a.normalized.length - 1),
                  (a.normalized[c][s.columns].$row = a.normalized[c][
                    s.columns
                  ].$row.add(x)),
                  x.prev().hasClass(s.cssChildRow) ||
                    x.prev().addClass(g.css.cssHasChild),
                  (p.child[c] = h.trim(
                    x[0].textContent || x[0].innerText || x.text() || ""
                  ));
              else {
                p.$row = x;
                p.order = f;
                for (e = 0; e < s.columns; ++e)
                  "undefined" === typeof w[e]
                    ? s.debug &&
                      d(
                    ...
                    : ((c = r(b, x[0].cells[e], e)),
                      (c =
                        "undefined" === typeof v[e].id
                          ? c
                          : v[e].format(c, b, x[0].cells[e], e)),
                      (c =
                        "no-parser" === w[e].id
                          ? ""
                          : w[e].format(c, b, x[0].cells[e], e)),
                      k.push(
                        s.ignoreCase && "string" === typeof c
                          ? c.toLowerCase()
                          : c
                      ),
                      "numeric" === (w[e].type || "").toLowerCase() &&
                        (u[e] = Math.max(Math.abs(c) || 0, u[e] || 0)));
                k[s.columns] = p;
                a.normalized.push(k);
              }
            a.colMax = u;
      ...
      function z(b, a) {
        ...
        if (p(d))
          return c.appender
            ? c.appender(b, l)
            : b.isUpdating
            ? c.$table.trigger("updateComplete", b)
            : "";
        c.debug && (s = new Date());
        for (u = 0; u < e.length; u++)
          if (((k = h(e[u])), k.length && !k.hasClass(c.cssInfoBlock))) {
            ...
            n = k.length;
            for (r = 0; r < n; r++)
              l.push(k[r][c.columns].$row),
                (c.appender &&
                  (!c.pager ||
                    (c.pager.removeRows && f.pager_removeRows) ||
                    c.pager.ajax)) ||
                  m.append(k[r][c.columns].$row);
      ...
      function E(b) {
        ...
        n.headerContent = [];
        n.debug && (k = new Date());
        n.columns = g.computeColumnIndex(
          n.$table.children("thead, tfoot").children("tr")
        );
        e = n.cssIcon
          ? '<i class="' +
            (n.cssIcon === g.css.icon
              ? g.css.icon
              : n.cssIcon + " " + g.css.icon) +
            '"></i>'
          : "";
        n.$headers = h(b)
          ...
          .each(function (k) {
            ...
            "" !== n.headerTemplate &&
              ((l = n.headerTemplate
                .replace(/\{content\}/g, h(this).html())
                .replace(/\{icon\}/g, e)),
              n.onRenderTemplate &&
                (f = n.onRenderTemplate.apply(c, [k, l])) &&
                "string" === typeof f &&
                (l = f),
              h(this).html(
                '<div class="' + g.css.headerIn + '">' + l + "</div>"
              ));
            n.onRenderHeader && n.onRenderHeader.apply(c, [k]);
            this.column = parseInt(h(this).attr("data-column"), 10);
            this.order = D(
              g.getData(c, a, "sortInitialOrder") || n.sortInitialOrder
            )
              ? [1, 0, 2]
              : [0, 1, 2];
            this.count = -1;
            ...
            "undefined" !== typeof x &&
              !1 !== x &&
              (this.order = this.lockedOrder = D(x) ? [1, 1, 1] : [0, 0, 0]);
            c.addClass(g.css.header + " " + n.cssHeader);
            n.headerList[k] = this;
            c.parent()
              .addClass(g.css.headerRow + " " + n.cssHeaderRow)
              .attr("role", "row");
      ...
      function H(b) {
        ...
        e.$headers.each(function (l, d) {
          ...
          a =
            "false" === g.getData(d, f, "sorter") ||
            "false" === g.getData(d, f, "parser");
          d.sortDisabled = a;
          c[a ? "addClass" : "removeClass"]("sorter-false").attr(
            "aria-disabled",
            "" + a
          );
          b.id &&
            ...
            for (c = 0; c < b.length; c++)
              b[c].sortDisabled ||
                b
                  ...
                  .removeClass(d)
                  .addClass(k[e[a][1]])
                  .attr("aria-sort", n[e[a][1]]);
            m.length &&
              m
                .filter('[data-column="' + e[a][0] + '"]')
                .removeClass(d)
                .addClass(k[e[a][1]]);
          }
        f.$headers.not(".sorter-false").each(function () {
          var b = h(this),
            ...
            a =
              ...
              ": " +
              g.language[
                b.hasClass(g.css.sortAsc)
                  ? "sortAsc"
                  : b.hasClass(g.css.sortDesc)
                  ? "sortDesc"
                  : "sortNone"
              ] +
              g.language[
                0 === a ? "nextAsc" : 1 === a ? "nextDesc" : "nextNone"
              ];
          b.attr("aria-label", a);
        });
      }
      function O(b) {
        var a,
          ...
          f = b.config;
        f.widthFixed &&
          0 === f.$table.find("colgroup").length &&
          ((a = h("<colgroup>")),
          (c = h(b).width()),
          h(b.tBodies)
            .not("." + f.cssInfoBlock)
            ...
            .each(function () {
              a.append(
                h("<col>").css(
                  "width",
                  parseInt((h(this).width() / c) * 1e3, 10) / 10 + "%"
                )
              );
            }),
          f.$table.prepend(a));
      ...
      function L(b, a, c) {
        ...
        k.sortRestart &&
          ...
          k.$headers.each(function () {
            this === e ||
              (!n && h(this).is("." + g.css.sortDesc + ",." + g.css.sortAsc)) ||
              (this.count = -1);
          }));
        e = a.column;
        if (n) {
          k.sortList = [];
          if (null !== k.sortForce)
            for (f = k.sortForce, l = 0; l < f.length; l++)
              f[l][0] !== e && k.sortList.push(f[l]);
          f = a.order[a.count];
          if (2 > f && (k.sortList.push([e, f]), 1 < a.colSpan))
            for (l = 1; l < a.colSpan; l++) k.sortList.push([e + l, f]);
        } else {
          if (k.sortAppend && 1 < k.sortList.length)
            for (l = 0; l < k.sortAppend.length; l++)
              (d = g.isValueInArray(k.sortAppend[l][0], k.sortList)),
                0 <= d && k.sortList.splice(d, 1);
          if (0 <= g.isValueInArray(e, k.sortList))
            for (l = 0; l < k.sortList.length; l++)
              (d = k.sortList[l]),
                (f = k.$headers.filter('[data-column="' + d[0] + '"]:last')[0]),
                d[0] === e &&
                  ((d[1] = f.order[a.count]),
                  2 === d[1] && (k.sortList.splice(l, 1), (f.count = -1)));
          else if (
            ((f = a.order[a.count]),
            2 > f && (k.sortList.push([e, f]), 1 < a.colSpan))
          )
            for (l = 1; l < a.colSpan; l++) k.sortList.push([e + l, f]);
        }
        if (null !== k.sortAppend)
          for (f = k.sortAppend, l = 0; l < f.length; l++)
            f[l][0] !== e && k.sortList.push(f[l]);
      ...
      function J(b) {
        ...
        if (!t.serverSideSorting && !p(t.cache)) {
            ...
            (d = t.cache[c].colMax),
              ...
              k.sort(function (c, l) {
                for (a = 0; a < y; a++) {
                  ...
                  (f = /n/i.test(Q(t.parsers, e))) && t.strings[e]
                    ? ((f =
                        "boolean" === typeof t.string[t.strings[e]]
                          ? (s ? 1 : -1) * (t.string[t.strings[e]] ? -1 : 1)
                          : t.strings[e]
                          ? t.string[t.strings[e]] || 0
                          : 0),
                      (m = t.numberSorter
                        ? t.numberSorter(c[e], l[e], s, d[e], b)
                        : g["sortNumeric" + (s ? "Asc" : "Desc")](
                            c[e],
                            l[e],
                            f,
                            d[e],
                    ...
                    : ((r = s ? c : l),
                      ...
                      (m =
                        "function" === typeof v
                          ? v(r[e], u[e], s, e, b)
                          : "object" === typeof v && v.hasOwnProperty(e)
                          ? v[e](r[e], u[e], s, e, b)
                          : g["sortNatural" + (s ? "Asc" : "Desc")](
                              c[e],
                              l[e],
                              e,
                              b,
          ...
          t.debug &&
            q("Sorting on " + w.toString() + " and dir " + h + " time", l);
        }
      }
      function M(b, a) {
        var c = b[0];
      ...
      function N(b) {
        ...
        c.unbind(
          ...
          .bind("sortReset" + a.namespace, function (f, e) {
            f.stopPropagation();
            a.sortList = [];
            F(b);
            J(b);
          ...
          .bind(
            "update" + a.namespace + " updateRows" + a.namespace,
            function (a, e, c) {
              a.stopPropagation();
              b.isUpdating = !0;
              H(b);
          ...
          .bind("updateCell" + a.namespace, function (f, e, l, g) {
            ...
            f = n.index(
              h.fn.closest
                ? m.closest("tbody")
                : m.parents("tbody").filter(":first")
            );
            d = h.fn.closest
              ? m.closest("tr")
              : m.parents("tr").filter(":first");
            e = m[0];
            n.length &&
              0 <= f &&
              ((n = n.eq(f).find("tr").index(d)),
              (m = m.index()),
              (a.cache[f].normalized[n][a.columns].$row = d),
              (d =
                "undefined" === typeof a.extractors[m].id
                  ? r(b, e, m)
                  : a.extractors[m].format(r(b, e, m), b, e, m)),
              (e =
                "no-parser" === a.parsers[m].id
                  ? ""
                  : a.parsers[m].format(d, b, e, m)),
              (a.cache[f].normalized[n][m] =
                a.ignoreCase && "string" === typeof e ? e.toLowerCase() : e),
              "numeric" === (a.parsers[m].type || "").toLowerCase() &&
                (a.cache[f].colMax[m] = Math.max(
                  Math.abs(e) || 0,
                  a.cache[f].colMax[m] || 0
                )),
              I(c, l, g));
          })
          .bind("addRows" + a.namespace, function (f, e, l, g) {
            ...
            if (p(a.cache)) H(b), C(b, l, g);
              ...
              for (f = 0; f < s; f++) {
                ...
                for (d = 0; d < n; d++)
                  (m =
                    "undefined" === typeof a.extractors[d].id
                      ? r(b, e[f].cells[d], d)
                      : a.extractors[d].format(
                          r(b, e[f].cells[d], d),
                          b,
                          e[f].cells[d],
                          d
                    ...
                    (m =
                      "no-parser" === a.parsers[d].id
                        ? ""
                        : a.parsers[d].format(m, b, e[f].cells[d], d)),
                    (u[d] =
                      a.ignoreCase && "string" === typeof m
                        ? m.toLowerCase()
                        : m),
                    "numeric" === (a.parsers[d].type || "").toLowerCase() &&
                      (a.cache[t].colMax[d] = Math.max(
                        Math.abs(u[d]) || 0,
                        a.cache[t].colMax[d] || 0
                      ));
                u.push(q);
      ...
      g.construct = function (b) {
        return this.each(function () {
          ...
          !this.hasInitialized && g.buildTable && "TABLE" !== this.tagName
            ? g.buildTable(this, a)
            : g.setup(this, a);
        });
      };
      g.setup = function (b, a) {
        ...
        /tablesorter\-/.test(f.attr("class")) ||
          (c = "" !== a.theme ? " tablesorter-" + a.theme : "");
        a.table = b;
        a.$table = f
          .addClass(g.css.table + " " + a.tableClass + c)
          .attr("role", "grid");
        a.$headers = f.find(a.selectorHeaders);
        a.namespace = a.namespace
          ? "." + a.namespace.replace(/\W/g, "")
          : ".tablesorter" + Math.random().toString(16).slice(2);
        a.$table.children().children("tr").attr("role", "row");
        a.$tbodies = f
          .children("tbody:not(." + a.cssInfoBlock + ")")
          .attr({ "aria-live": "polite", "aria-relevant": "all" });
        a.$table.find("caption").length &&
          a.$table.attr("aria-labelledby", "theCaption");
        a.widgetInit = {};
        a.textExtraction =
          a.$table.attr("data-text-extraction") || a.textExtraction || "basic";
        E(b);
        O(b);
        v(b);
        a.totalRows = 0;
        ...
        g.bindEvents(b, a.$headers, !0);
        N(b);
        a.supportsDataObject && "undefined" !== typeof f.data().sortlist
          ? (a.sortList = f.data().sortlist)
          : e &&
            f.metadata() &&
            f.metadata().sortlist &&
            (a.sortList = f.metadata().sortlist);
        g.applyWidget(b, !0);
        0 < a.sortList.length
          ? f.trigger("sorton", [a.sortList, {}, !a.initWidgets, !0])
          : (F(b), a.initWidgets && g.applyWidget(b, !1));
        a.showProcessing &&
          f
            .unbind("sortBegin" + a.namespace + " sortEnd" + a.namespace)
            .bind(
              "sortBegin" + a.namespace + " sortEnd" + a.namespace,
              function (c) {
                clearTimeout(a.processTimer);
                g.isProcessing(b);
                "sortBegin" === c.type &&
                  (a.processTimer = setTimeout(function () {
                    g.isProcessing(b, !0);
                  }, 500));
              }
            );
        ...
        if ("undefined" !== typeof a && null !== a) {
          ...
          if (a[c])
            return f
              ...
              : a[
                  d.$headers.index(
                    d.$headers.filter('[data-column="' + c + '"]:last')
                  )
                ];
          for (e in a)
            if (
              "string" === typeof e &&
              ((b = f
                ? d.$headers.eq(c).filter(e)
                : d.$headers
                    .filter('[data-column="' + c + '"]:last')
                    .filter(e)),
              b.length)
            )
              return a[e];
      ...
      g.computeColumnIndex = function (b) {
        ...
        for (f = 0; f < b.length; f++)
          for (k = b[f].cells, e = 0; e < k.length; e++) {
            ...
            for (d = n; d < n + m; d++)
              for (
                "undefined" === typeof a[d] && (a[d] = []), s = a[d], g = q;
                g < q + p;
                g++
              )
                s[g] = "x";
          ...
          ? ("undefined" !== typeof c &&
              ...
              (e = e.filter(function () {
                return this.sortDisabled
                  ...
                  : 0 <=
                      g.isValueInArray(
                        parseFloat(h(this).attr("data-column")),
                        f.sortList
                      );
              })),
            b.add(e).addClass(g.css.processing + " " + f.cssProcessing))
          : b.add(e).removeClass(g.css.processing + " " + f.cssProcessing);
      };
      ...
      g.bindEvents = function (b, a, c) {
        ...
        var f,
          e = b.config;
        !0 !== c &&
          (e.$extraHeaders = e.$extraHeaders ? e.$extraHeaders.add(a) : a);
        a.find(e.selectorSort)
          .add(a.filter(e.selectorSort))
          .unbind(
            ["mousedown", "mouseup", "sort", "keyup", ""].join(
              e.namespace + " "
            )
          )
          .bind(
            ...
            function (c, d) {
              ...
              if (
                !(
                  (1 !== (c.which || c.button) && !/sort|keyup/.test(g)) ||
                  ("keyup" === g && 13 !== c.which) ||
                  ("mouseup" === g &&
                    !0 !== d &&
                    250 < new Date().getTime() - f)
                )
              ) {
                if ("mousedown" === g)
                  return (
                    (f = new Date().getTime()),
                    /(input|select|button|textarea)/i.test(c.target.tagName)
                      ? ""
                      : !e.cancelSelection
                  );
                e.delayInit && p(e.cache) && w(b);
                g = h.fn.closest
                  ? h(this).closest("th, td")[0]
                  : /TH|TD/.test(this.tagName)
                  ? this
                  : h(this).parents("th, td")[0];
      ...
      g.restoreHeaders = function (b) {
        ...
        a.$table.find(a.selectorHeaders).each(function (b) {
          h(this).find("." + g.css.headerIn).length &&
            h(this).html(a.headerContent[b]);
        });
      };
      g.destroy = function (b, a, c) {
        ...
        if (b.hasInitialized) {
          ...
          var f = h(b),
            ...
            q = d
              .find("tr." + g.css.headerRow)
              .removeClass(g.css.headerRow + " " + e.cssHeaderRow),
            k = f.find("tfoot:first > tr").children("th, td");
          !1 === a &&
            0 <= h.inArray("uitheme", e.widgets) &&
            (f.trigger("applyWidgetId", ["uitheme"]),
            f.trigger("applyWidgetId", ["zebra"]));
          d.find("tr").not(q).remove();
          f.removeData("tablesorter").unbind(
          ...
          q.find(e.selectorSort).unbind(
            ["mousedown", "mouseup", "keypress", ""].join(e.namespace + " ")
          );
          g.restoreHeaders(b);
          f.toggleClass(
            g.css.table + " " + e.tableClass + " tablesorter-" + e.theme,
            !1 === a
          );
          b.hasInitialized = !1;
      ...
      g.replaceAccents = function (b) {
        ...
        if (!g.characterRegex) {
          ...
          for (a in d)
            "string" === typeof a &&
              ((c += d[a]),
              (g.characterRegexArray[a] = new RegExp("[" + d[a] + "]", "g")));
          g.characterRegex = new RegExp(c + "]");
        }
        if (g.characterRegex.test(b))
          for (a in d)
            "string" === typeof a &&
              (b = b.replace(g.characterRegexArray[a], a));
        return b;
      };
      ...
      g.addParser = function (b) {
        var a,
          ...
          d = !0;
        for (a = 0; a < c; a++)
          g.parsers[a].id.toLowerCase() === b.id.toLowerCase() && (d = !1);
        d && g.parsers.push(b);
      };
      g.getParserById = function (b) {
        ...
        var a,
          c = g.parsers.length;
        for (a = 0; a < c; a++)
          if (g.parsers[a].id.toLowerCase() === b.toString().toLowerCase())
            return g.parsers[a];
        return !1;
      };
      ...
      g.getWidgetById = function (b) {
        ...
        for (a = 0; a < d; a++)
          if (
            (c = g.widgets[a]) &&
            c.hasOwnProperty("id") &&
            c.id.toLowerCase() === b.toLowerCase()
          )
            return c;
      };
      g.applyWidget = function (b, a) {
        ...
        (!1 !== a &&
          ...
          c.widgets.length &&
            ...
            (c.widgets = h.grep(c.widgets, function (a, b) {
              return h.inArray(a, c.widgets) === b;
            })),
            h.each(c.widgets || [], function (a, b) {
              (k = g.getWidgetById(b)) &&
                k.id &&
                (k.priority || (k.priority = 10), (e[a] = k));
            }),
            e.sort(function (a, b) {
            ...
            h.each(e, function (e, g) {
              if (g) {
                if (a || !c.widgetInit[g.id])
                  (c.widgetInit[g.id] = !0),
                    g.hasOwnProperty("options") &&
                      (d = b.config.widgetOptions = h.extend(
                        !0,
                        {},
                        g.options,
                        d
      ...
      g.refreshWidgets = function (b, a, c) {
        ...
        for (f = 0; f < k; f++)
          q[f] &&
            q[f].id &&
            (a || 0 > h.inArray(q[f].id, l)) &&
            (e.debug && d('Refeshing widgets: Removing "' + q[f].id + '"'),
            q[f].hasOwnProperty("remove") &&
              e.widgetInit[q[f].id] &&
              (q[f].remove(b, e, e.widgetOptions),
              (e.widgetInit[q[f].id] = !1)));
      ...
      g.getData = function (b, a, c) {
        ...
        g = " " + (b.attr("class") || "");
        "undefined" !== typeof b.data(c) ||
        "undefined" !== typeof b.data(c.toLowerCase())
          ? (d += b.data(c) || b.data(c.toLowerCase()))
          : e && "undefined" !== typeof e[c]
          ? (d += e[c])
          : a && "undefined" !== typeof a[c]
          ? (d += a[c])
          : " " !== g &&
            g.match(" " + c + "-") &&
            (d = g.match(new RegExp("\\s" + c + "-([\\w-]+)"))[1] || "");
        return h.trim(d);
      };
      g.formatFloat = function (b, a) {
        ...
        b = (
          a && a.config
            ? !1 !== a.config.usNumberFormat
            : "undefined" !== typeof a
            ? a
            : 1
        )
          ? b.replace(/,/g, "")
          : b.replace(/[\s|\.]/g, "").replace(/,/g, ".");
  ...
  r.addParser({
    ...
    format: function (d, q) {
      var p = q.config;
      d &&
        ((d = h.trim(p.ignoreCase ? d.toLocaleLowerCase() : d)),
        (d = p.sortLocaleCompare ? r.replaceAccents(d) : d));
      return d;
    },
    type: "text",
  });
  r.addParser({
    ...
    format: function (d, q) {
      ...
      return d && "number" === typeof p
        ? p
        : d
        ? h.trim(d && q.config.ignoreCase ? d.toLocaleLowerCase() : d)
        : d;
    },
    type: "numeric",
  });
  ...
  r.addParser({
    ...
    format: function (d, h) {
      return d
        ? r.formatFloat(
            "" !== d ? new Date(d.replace(/-/g, "/")).getTime() || d : "",
            h
          )
        : d;
    },
    ...
    is: function (d) {
      return (
        /^[A-Z]{3,10}\.?\s+\d{1,2},?\s+(\d{4})(\s+\d{1,2}:\d{2}(:\d{2})?(\s+[AP]M)?)?$/i.test(
          d
        ) || /^\d{1,2}\s+[A-Z]{3,10}\s+\d{4}/i.test(d)
      );
    },
    format: function (d, h) {
      return d
        ? r.formatFloat(
            new Date(d.replace(/(\S)([AP]M)$/i, "$1 $2")).getTime() || d,
            h
          )
        : d;
    },
  ...
  r.addParser({
    ...
    format: function (d, h, p, y) {
      if (d) {
        ...
        y =
          (v.length && v[0].dateFormat) ||
          r.getData(v, r.getColumnData(h, p.headers, y), "dateFormat") ||
          p.dateFormat;
  ...
  r.addParser({
    ...
    format: function (d, h) {
      return d
        ? r.formatFloat(
            new Date(
              "2000/01/01 " + d.replace(/(\S)([AP]M)$/i, "$1 $2")
            ).getTime() || d,
            h
          )
        : d;
  ...
  r.addWidget({
    ...
    remove: function (d, q, p) {
      ...
      for (p = 0; p < q.length; p++)
        (r = h.tablesorter.processTbody(d, q.eq(p), !0)),
